package microservices.users.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "microservices.users.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "microservices.users.model" });
