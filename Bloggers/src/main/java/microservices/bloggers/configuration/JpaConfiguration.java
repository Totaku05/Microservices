package microservices.bloggers.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "microservices.bloggers.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "microservices.bloggers.model" });
