package microservices.orders.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "microservices.orders.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "microservices.orders.model" });
