package microservices.identification.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "microservices.identification.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "microservices.identification.model" });
